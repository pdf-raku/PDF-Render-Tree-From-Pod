...
my $ast =
    :Document[:Lang("en"),
              ...
              :Div[:role("Declaration"), :H3["Attribute t"], :P["This is an attribute"], :Code[:Placement("Block"), :role("Raku"), "has Str \$.t"]],
              :Div[:role("Declaration"), :H3["Method asdf"], :P["This is a method"], :Code[:Placement("Block"), :role("Raku"), "method asdf(\n    Str :\$asdf = \"asdf\",\n) returns Str"]]
             ];
