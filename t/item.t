...
my $ast =
    :Document[:Lang("en"),
              ...
              :L[:LI[:LBody[:P["Top Item"],
                            :L[:LI[:Lbl["1."], :LBody[:P["First numbered sub-item"]]],
                               :LI[:Lbl["2."], :LBody[:P["Second numbered sub-item"]]],
                               :LI[:LBody[:P["Un-numbered sub-item"]]]]]],
                 :LI[:LBody[:P["Paragraph item"]]]],
              :P["asdf"],
              :L[:LI[:LBody[:P["Block item"]]]],
              :P["asdf"],
              :L[:LI[:LBody[:P["Abbreviated"]]],
                 :LI[:LBody[:P["Paragraph item"]]],
                 :LI[:LBody[:P["Block item"], :P["with multiple"], :P["paragraphs"]]]],
              :P["asdf"]
             ];
