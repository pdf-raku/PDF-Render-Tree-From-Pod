...
my $ast = :Document[:Lang("en"), :H2["Outer"], :P["This is an outer paragraph"], :H3["Inner1"], :P["This is the first inner paragraph"], :H3["Inner2"], :P["This is the second inner paragraph"]];
